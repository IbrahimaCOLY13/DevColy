...
class PresentationSig(QgsProcessingAlgorithm):
    ...
    def initAlgorithm(self, config=None):
        self.addParameter(QgsProcessingParameterFile('chemin_du_logo', 'Chemin du Logo', behavior=QgsProcessingParameterFile.File, fileFilter='Images (*.png *.jpg *.jpeg *.svg);;Tous les fichiers (*.*)', defaultValue='R:\\SIG\\06_Elements_de_legende\\Logos'))
