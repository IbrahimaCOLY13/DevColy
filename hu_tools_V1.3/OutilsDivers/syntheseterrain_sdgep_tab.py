...
from .Provider_syntheseterrain_sdgep import Provider_SyntheseTerrain_sdgep

# Chargement de l'interface Qt
FORM_CLASS, _ = uic.loadUiType(os.path.join(
    os.path.dirname(__file__), 'syntheseterrain_sdgep_tab.ui'))


class SyntheseTerrainSdgepTab(QtWidgets.QDialog, FORM_CLASS):
    def __init__(self, iface=None, parent=None):
        ...
        self.provider = Provider_SyntheseTerrain_sdgep()
